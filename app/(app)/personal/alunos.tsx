    ...
    <View style={styles.pedidospersonalview}>
      <View style={styles.rounds}>
        ...
        <View style={[styles.view, styles.viewLayout1]}>
          ...
          <Image style={styles.imageIcon} source={require("@/assets/images/gym/image8.png")}/>
          <Text style={[styles.jumpingJacks, styles.text3Typo]}>Jumping Jacks</Text>
          <Text style={[styles.text, styles.minTypo]}>00:30</Text>
          <Image style={styles.icPlayIcon} source={require("@/assets/images/gym/ic-play.png")}/>
        </View>
      ...
      <View style={[styles.navigation, styles.backIconLayout]}>
        ...
        <Image style={[styles.backIcon, styles.backIconLayout]} source={require("@/assets/images/gym/back1.png")}
        />
      </View>
      <View style={styles.bestForYou}>
        ...
        <View style={[styles.view3, styles.viewLayout]}>
          ...
          />
          <Text style={styles.bellyFatBurner}>Fernanda</Text>
          <View style={[styles.minWrapper, styles.wrapperPosition]}>
            <Text style={[styles.min, styles.minTypo]}>Paulo Afonso</Text>
          </View>
          <View style={[styles.beginnerWrapper, styles.wrapperPosition]}>
            <Text style={[styles.min, styles.minTypo]}>Musculação</Text>
          </View>
        </View>
        <View style={[styles.view4, styles.viewLayout]}>
          ...
          />
          <Text style={styles.bellyFatBurner}>Clara</Text>
          <View style={[styles.minWrapper, styles.wrapperPosition]}>
            <Text style={[styles.min, styles.minTypo]}>Paulo Afonso</Text>
          </View>
          <View style={[styles.beginnerWrapper, styles.wrapperPosition]}>
        ...
        <View style={[styles.view5, styles.viewPosition]}>
          ...
          />
          <Text style={styles.bellyFatBurner}>Júlia</Text>
          <View style={[styles.minWrapper, styles.wrapperPosition]}>
            <Text style={[styles.min, styles.minTypo]}>Glória</Text>
          </View>
          <View style={[styles.beginnerWrapper, styles.wrapperPosition]}>
            <Text style={[styles.min, styles.minTypo]}>Pilates</Text>
          </View>
        </View>
        <View style={[styles.view6, styles.viewPosition]}>
          ...
          />
          <Text style={styles.bellyFatBurner}>Carlos</Text>
          <View style={[styles.minWrapper, styles.wrapperPosition]}>
            <Text style={[styles.min, styles.minTypo]}>Paulo Afonso</Text>
          </View>
          <View style={[styles.beginnerWrapper, styles.wrapperPosition]}>
